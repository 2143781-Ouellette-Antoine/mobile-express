...
12. Vérifier que cliquer sur le bouton « Modifier » ouvre bien un formulaire de modification. [:heavy_check_mark:]
...
16. Vérifier que la page de toutes les compagnies affiche bien toutes les compagnies. [:heavy_check_mark:]
...
25. Vérifier que les anciennes données du téléphone intelligent sont préremplies dans le formulaire de modification. [:heavy_check_mark:]
...
28. Vérifier que les données minimales et maximales des curseur de défilement dans la page de recherche sont bien interprétées par le système. [:heavy_check_mark:]
...
31. Vérifier que les valeurs par défaut des curseur de défilement sont appliquées. [:heavy_check_mark:]
32. Vérifier que le champ texte pour rechercher du texte contenu dans le nom du téléphone intelligent fonctionne correctement et qu'il n'y a pas besoin d'écrire le nom complet. [:heavy_check_mark:]
33. Vérifier que les couleurs dans la page de recherche sont bien traitées pour être converties en tableau. [:heavy_check_mark:]
34. Vérifier qu'il est possible d'ajouter des configurations de mémoire vive et de stockage dans la liste des formulaires de création et de modification. [:heavy_check_mark:]
35. Vérifier qu'il est possible de supprimer des configurations de mémoire vive et de stockage dans la liste des formulaires de création et de modification. [:heavy_check_mark:]
36. Vérifier que les boutons « Annuler » ferment bien les fenêtres contextuelles des formulaires. [:heavy_check_mark:]
37. Vérifier qu'il y a une rétroaction de chargement pendant que les anciennes données sont récupérées depuis l'API lors de l'ouverture de la fenêtre contextuelle de modification d'un téléphone intelligent. [:heavy_check_mark:]
38. Vérifier que le site affiche une page 404 quand l'utilisateur essaie d'accéder à un URL qui n'existe pas. [:heavy_check_mark:]