 ...
 */
function ListeTousTelephonesIntelligents() {
    /**
     * Récupération des variables d'état et des méthodes de ListeTousTelephonesIntelligents dans le hook.
...
export default ListeTousTelephonesIntelligents